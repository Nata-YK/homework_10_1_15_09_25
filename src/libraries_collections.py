...
def count_transactions(dict_list, class_list):
    ...
    for key in dict_list: # Итерируемся по списку словарей
        if key.get("description") == class_list: # Сравниваем заданное значение "class_list" с заданным классом "description"
            filtered_transactions.append(key["description"]) # Если сравнение верно, добавляем данный ключ в новый список
